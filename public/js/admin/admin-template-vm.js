                        ...
                        <div class="d-block d-md-none">
                            ...
                            <div v-for="vm in userVms" :key="vm.id" class="vm-mobile-card">
                                ...
                                <div class="vm-mobile-card-body">
                                    ...
                                    <div v-if="networkConfig.cname_domain" class="vm-mobile-card-row"><span class="vm-mobile-card-label">CNAME</span><span class="vm-mobile-card-value text-primary" style="line-height:1.5;"><div v-for="cname in formatCnameList(networkConfig.cname_domain, vm.vm_id)" :key="cname">{{ cname }}</div></span></div>
