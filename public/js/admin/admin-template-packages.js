                    ...
                    <div v-if="activeTabPackages === 'vm'" class="tab-panel">
                        ...
                        <div v-if="packagePage.vmPackageGroups.value.length > 0" class="mb-3">
                            <span v-for="g in packagePage.vmPackageGroups.value" :key="g.id"
                                ...
                                draggable="true"
                                :class="{ 'row-dragging': packagePage.dragState.draggingId === g.id, 'badge-avoid-right': packagePage.dragState.avoidUpIds.indexOf(g.id) !== -1, 'badge-avoid-left': packagePage.dragState.avoidDownIds.indexOf(g.id) !== -1 }"
                            ...
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    <tr v-for="p in packagePage.vmPackages.value" :key="p.id"
                                        draggable="true"
                                        :class="{ 'row-dragging': packagePage.dragState.draggingId === p.id, 'row-avoid-up': packagePage.dragState.avoidUpIds.indexOf(p.id) !== -1, 'row-avoid-down': packagePage.dragState.avoidDownIds.indexOf(p.id) !== -1 }"
